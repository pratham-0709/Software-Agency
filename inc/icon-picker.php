...
class Software_Agency_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'software-agency' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $software_agency_font_awesome_icon_array = software_agency_font_awesome_icon_array();
                    foreach ($software_agency_font_awesome_icon_array as $software_agency_font_awesome_icon) {
                            $icon_class = $this->value() == $software_agency_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($software_agency_font_awesome_icon).'"></i>
                            <span class="software-agency-social-class">'.esc_attr($software_agency_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function software_agency_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'software-agency-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'software_agency_customizer_script' );

if(!function_exists('software_agency_font_awesome_icon_array')){
    function software_agency_font_awesome_icon_array(){
